...
export function Component() {
  ...
  useEffect(() => {
    // --- LIFECYCLE STATE (lifted to effect scope so cleanup can reach it) ---
    let disposed = false;
    let rafId = 0;
    ...
    const initApplication = async () => {
      ...
      const slides = [
        {title: 'Ethereal Glow', description: 'A soft, radiant light that illuminates the soul.', media: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?q=80&w=1080&auto=format&fit=crop'},
        {title: 'Rose Mirage', description: 'Lost in a desert of blooming dreams and endless horizons.', media: 'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?q=80&w=1080&auto=format&fit=crop'},
        {title: 'Velvet Mystique', description: 'Wrapped in the deep, luxurious embrace of the night.', media: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=1080&auto=format&fit=crop'},
        {title: 'Golden Hour', description: 'That fleeting moment when the world is dipped in gold.', media: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1080&auto=format&fit=crop'},
        {title: 'Midnight Dreams', description: 'Where reality fades and imagination takes flight.', media: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=1080&auto=format&fit=crop'},
        {title: 'Silver Light', description: 'A cool, metallic shimmer reflecting the urban pulse.', media: 'https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?q=80&w=1080&auto=format&fit=crop'},
      ];
        ...
        new Promise<any>((resolve, reject) => {
          ...
          l.load(
            ...
            (t: any) => {
              ...
              // Color textures sampled by a custom shader: keep them in sRGB.
      ...
      const initRenderer = async () => {
        ...
        for (const s of slides) {
          ...
          if (disposed) return; // Unmounted mid-load — bail before touching GL state
        }
    ...
    // --- TEARDOWN: stop the loop, timers and listeners; release GPU memory ---
    return () => {
      disposed = true;
